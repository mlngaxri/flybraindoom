...
Used for browser connectome data, neuron metadata and the whole-brain LIF simulation modules. Runtime URLs are pinned to commit `26672e06427c12c61536ce1bd93dae7442944681`.

## doom-wasm / Chocolate Doom WebAssembly

Repository: https://github.com/gabrielbotandev/doom-wasm

Used for the browser Chocolate Doom engine and its bundled freely redistributable Freedoom data. Runtime URLs are pinned to commit `64de0924591dec59a7d49a7d10467e125b50ea99` and loaded from jsDelivr.
